...
>
> Absorbed in wave **M4a** (2026-08-29) of the estate's service-merge sequence.
>
> **The canonical source is [`micro-agora`](https://github.com/cloudsforge-online/micro-agora)
> at [`src/emberkin/nda/`](https://github.com/cloudsforge-online/micro-agora/tree/main/src/emberkin/nda).
...
> It arrived there in two steps: M4a merged it into `emberkin`, and `emberkin` itself became a module of `agora` later in the sequence. The nesting is preserved — the source sits at `src/emberkin/nda`, one level deeper than the modules that moved directly.
>
>
